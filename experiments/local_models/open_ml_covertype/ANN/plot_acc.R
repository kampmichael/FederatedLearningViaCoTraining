...
z2=d2[[3]]
z2 = apply(z2, 2, function(x)EMA_cpp(x,5))
g6 = ggplot() +
  ...
  xlab("Iteration of proposed method") + ylab("Agent's test accuracy") + ggtitle("30% reference dataset, 100% per iteration",subtitle = "lower dash = solo, higher dash = global, colour = agent")
...
jpeg(filename = "ANN_covertype_test_ACC.JPG", pointsize =12, quality = 100,width = 1800,height = 1500)

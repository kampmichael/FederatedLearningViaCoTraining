...
g1 = ggplot() +
  ...
  xlab("Iteration of proposed method") + ylab("Agent's test AUC") + ggtitle("20% reference dataset, 33% per iteration",subtitle = "lower dash = solo, higher dash = global, colour = agent")
...
g2 = ggplot() +
  ...
  xlab("Iteration of proposed method") + ylab("Agent's test AUC") + ggtitle("20% reference dataset, 66% per iteration",subtitle = "lower dash = solo, higher dash = global, colour = agent")
...
g3 = ggplot() +
  ...
  xlab("Iteration of proposed method") + ylab("Agent's test AUC") + ggtitle("20% reference dataset, 100% per iteration",subtitle = "lower dash = solo, higher dash = global, colour = agent")
...
g4 = ggplot() +
  ...
  xlab("Iteration of proposed method") + ylab("Agent's test AUC") + ggtitle("66% reference dataset, 33% per iteration",subtitle = "lower dash = solo, higher dash = global, colour = agent")
...
g5 = ggplot() +
  ...
  xlab("Iteration of proposed method") + ylab("Agent's test AUC") + ggtitle("66% reference dataset, 66% per iteration",subtitle = "lower dash = solo, higher dash = global, colour = agent")
...
g6 = ggplot() +
  ...
  xlab("Iteration of proposed method") + ylab("Agent's test AUC") + ggtitle("66% reference dataset, 100% per iteration",subtitle = "lower dash = solo, higher dash = global, colour = agent")
...
g7 = ggplot() +
  ...
  xlab("Iteration of proposed method") + ylab("Agent's test AUC") + ggtitle("80% reference dataset, 33% per iteration",subtitle = "lower dash = solo, higher dash = global, colour = agent")
...
g8 = ggplot() +
  ...
  xlab("Iteration of proposed method") + ylab("Agent's test AUC") + ggtitle("80% reference dataset, 66% per iteration",subtitle = "lower dash = solo, higher dash = global, colour = agent")
...
g9 = ggplot() +
  ...
  xlab("Iteration of proposed method") + ylab("Agent's test AUC") + ggtitle("80% reference dataset, 100% per iteration",subtitle = "lower dash = solo, higher dash = global, colour = agent")

jpeg(filename = "RF_eye_test_AUC.JPG", pointsize =12, quality = 100,width = 1800,height = 1500)
